...
# load model
yolo_LP_detect = torch.hub.load('ultralytics/yolov5', 'custom', path='D:/ITS_LP/License-Plate-Recognition/model/LP_detector_nano_61.pt'
, force_reload=True)

yolo_license_plate = torch.hub.load(
    'D:/ITS_LP/License-Plate-Recognition/yolov5',
    'custom',
    path='D:/ITS_LP/License-Plate-Recognition/model/LP_ocr_nano_62.pt',
    force_reload=True,
    source='local'
)
